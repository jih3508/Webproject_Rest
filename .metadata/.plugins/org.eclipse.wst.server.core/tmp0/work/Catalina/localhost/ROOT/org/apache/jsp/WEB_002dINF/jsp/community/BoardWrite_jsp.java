 ...
 * Generated at: 2018-12-11 08:53:37 UTC
...
public final class BoardWrite_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t<div>\r\n");
      out.write("\t\t\t\t<form name=\"frm100\" method=\"post\" action=\"#\">\r\n");
      out.write("\t\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p class=\"wirte\">글쓰기</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td width=\"5\"><img src=\"img/table_right.gif\" width=\"5\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\theight=\"30\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<table style=\"width: 120%; height: 65%;\" border=\"0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr align=\"Left\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>&nbsp;</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td colspan=\"2\"><select name=\"board_kind\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"width: 15%; height: 25px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"no_select\" selected=\"selected\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"text-align: center;\">게시판 종류</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"notice\" style=\"text-align: center;\">공지사항</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"travel\" style=\"text-align: center;\">여행후기</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"event\" style=\"text-align: center;\">이벤트</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"Q&A\" style=\"text-align: center;\">Q&A</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</select></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>&nbsp;</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr height=\"10\" bgcolor=\"#FFFFFF\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td colspan=\"4\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr height=\"2\" bgcolor=\"#dddddd\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td colspan=\"4\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>&nbsp;</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td align=\"Left\" width=\"15%\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<p style=\"border: 1px solid; text-align: center;\">제목</p>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><input name=\"title\" style=\"width: 85%\" size=\"40\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>&nbsp;</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td colspan=\"2\"><textarea name=\"memo\" cols=\"92\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\trows=\"13\" style=\"width: 100%; height: 97%;\"></textarea></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>&nbsp;</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr height=\"3\" bgcolor=\"#dddddd\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td colspan=\"4\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr height=\"15\" bgcolor=\"#FFFFFF\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td colspan=\"4\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr height=\"2\" bgcolor=\"#82B5DF\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td colspan=\"4\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr height=\"15\" bgcolor=\"#FFFFFF\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td colspan=\"4\"></td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<img src=\"\\images\\basic_form\\logo.png\" width=\"60px\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\theight=\"40px\" />김영준 김하나 오다혜 이나연 조익현\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("</body>\r\n");
